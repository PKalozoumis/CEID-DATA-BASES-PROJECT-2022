...
-- Hacky identification method, given that the GUI connects directly to the database
-- ===========================================================================================================================================
CREATE TABLE logged_in_user
(
	user_AT CHAR(10) NOT NULL,
	
	PRIMARY KEY(user_AT),
	
	CONSTRAINT logged_in_worker
	FOREIGN KEY(user_AT) REFERENCES worker(wrk_AT)
	ON UPDATE CASCADE
	ON DELETE CASCADE
);