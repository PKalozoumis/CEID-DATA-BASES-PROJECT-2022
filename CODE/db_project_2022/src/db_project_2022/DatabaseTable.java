...
public class DatabaseTable
{
	...
	/*public String whereWithValues()
	{
		...
		for (int i = 0; i < keys.size(); ++i)
		{
			Integer j = (Integer)keyIter.next();
			str += columns.get(j).name() + " = '" + mainTable.getValueAt(mainTable.getSelectedRow(), j).toString() + "'";
	...
	/*public String editFieldString(int i)
	{
		String str = null;
		...
		{
			str = "'" + ((DatetimeFields)obj).toDatetimeString().replace("T", " ") + "'";
		}
